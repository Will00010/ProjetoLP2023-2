...
public class JDlgConsultaVendas extends javax.swing.JDialog {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jFmtData, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jTxtValor, javax.swing.GroupLayout.PREFERRED_SIZE, 338, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        if (jFmtData.getText().equals("") && jTxtValor.getText().equals("")) {
            List lista = vendasDAO.listAll();
            vendasControle.setList(lista);
        } else {
            if (!jFmtData.getText().equals("") && !jTxtValor.getText().equals("")) {
                try {
                    ...
                    Date data = strDate(jFmtData.getText());
                    double valor = Double.parseDouble(jTxtValor.getText());

                    List lista = vendasDAO.listDataTotal(data, valor);
                    vendasControle.setList(lista);
            ...
            if (!jTxtValor.getText().equals("")) {
                List lista = vendasDAO.listTotal(Double.parseDouble(jTxtValor.getText()));
                vendasControle.setList(lista);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgConsultaVendas.class
